 ...
 */
public class EHostKnowtatorAnnotation {
  /**
  ...
  public Span getCoveringSpan() {
    ...
    for (EHostKnowtatorAnnotation.Span span : this.spans) {
      if (span.begin < begin) {
        begin = span.begin;
      }
      if (span.end > end) {
   ...
   */
  public Map<String, EHostKnowtatorAnnotation> annotationSlots = new HashMap<String, EHostKnowtatorAnnotation>();

  /**
   * Construct a new KnowtatorAnnotation. (Not publicly available.)
   */
  EHostKnowtatorAnnotation() {
  }
  ...
  public boolean equals(Object obj) {
    ...
    EHostKnowtatorAnnotation that = (EHostKnowtatorAnnotation) obj;
